...
The experiments were finished with the conclusion that experiment0 gives the best results. For the limited amount of learning steps available it can be seen that adding further augmentations only worsens the results, the change of the optimizer similarly worsened the results.  
